...
// Daftarkan Service Worker: agar saat dibuka tanpa internet (mis. lewat app
// pembungkus web-to-app), yang tampil adalah shell aplikasi ini dari cache,
// bukan halaman error bawaan browser/WebView.
