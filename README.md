...
<button class="nav-btn" onclick="window.location.href='BACKGROUND.html'" style="color: var(--gold2); font-weight: 700; margin-left: auto;">📈BACKGROUND RHN CAPITAL ↗</button>
